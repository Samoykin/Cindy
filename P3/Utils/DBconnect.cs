    ...
    class DBconnect
    {
        ...
        public ObservableCollection<Employee> EmployeeRead()
        {
            ...
            foreach (DbDataRecord record in reader)
            {
                ...
                {
                    dtime = DateTime.ParseExact(record["tBirthDay"].ToString(), format, CultureInfo.CurrentCulture);
                    dtime2 = DateTime.ParseExact(record["tStartDay"].ToString(), format, CultureInfo.CurrentCulture);
                }
                else
                {
                    dtime = DateTime.ParseExact("24.12.1994", format, CultureInfo.CurrentCulture);
                    dtime2 = dtime;
                }
                empl = new Employee();
                ...
                empl.BirthDay = dtime.ToString();
                empl.StartDay = dtime2.ToString();
